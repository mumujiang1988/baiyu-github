...
public class ExcelUtil {
     ...
     * @param response  响应体
     */
    public static <T> void exportTemplateWithRequiredStyle(String sheetName, Class<T> clazz, HttpServletResponse response) {
        try {
            resetResponse(sheetName, response);
            ...
            // 2. 用 POI 打开刚生成的 Excel
            Workbook workbook = WorkbookFactory.create(new ByteArrayInputStream(bos.toByteArray()));
