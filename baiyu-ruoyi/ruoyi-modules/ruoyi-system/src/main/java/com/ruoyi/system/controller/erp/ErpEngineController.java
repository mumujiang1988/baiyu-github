...
import com.ruoyi.system.service.engine.FormValidationEngine;
import com.ruoyi.system.service.engine.ApprovalWorkflowEngine;
import com.ruoyi.system.service.engine.PushDownEngine;
import com.ruoyi.system.service.ErpApprovalFlowService;
import com.ruoyi.system.service.ErpPushRelationService;
import com.ruoyi.system.service.ISuperDataPermissionService;
import com.ruoyi.system.domain.vo.ErpApprovalFlowVo;
import com.ruoyi.system.domain.vo.ErpPushRelationVo;
...
public class ErpEngineController extends BaseController {
    ...
    // private final PushDownEngine pushEngine; // 暂未使用
    ...
    private final com.ruoyi.system.mapper.ErpApprovalHistoryMapper approvalHistoryMapper;
    ...
    public R<?> executeApproval(@RequestBody Map<String, Object> params) {
        try {
            ...
            if (result.isSuccess()) {
                // ✅ 保存审批历史到数据库
                com.ruoyi.system.domain.entity.ErpApprovalHistory history = 
                    new com.ruoyi.system.domain.entity.ErpApprovalHistory();
    ...
    public R<?> getApprovalHistory(@RequestBody Map<String, Object> params) {
        try {
            ...
            // 直接使用注入的 Mapper 查询
            com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<com.ruoyi.system.domain.entity.ErpApprovalHistory> queryWrapper = 
                new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<>();
            queryWrapper.eq("module_code", moduleCode)
                       .eq("bill_id", billId)
                       .orderByDesc("approval_time");
            
            java.util.List<com.ruoyi.system.domain.entity.ErpApprovalHistory> historyList = 
                approvalHistoryMapper.selectList(queryWrapper);
            
            // 转换为 VO 对象
            java.util.List<Map<String, Object>> result = new ArrayList<>();
            for (com.ruoyi.system.domain.entity.ErpApprovalHistory item : historyList) {
