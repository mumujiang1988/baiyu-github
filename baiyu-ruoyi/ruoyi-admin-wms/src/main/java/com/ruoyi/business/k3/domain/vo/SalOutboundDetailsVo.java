...
@Data
@AutoMapper(target = SalOutboundDetails.class)
public class SalOutboundDetailsVo {
    @TableId(value = "id")
    private Long id;
    //实体主键
     ...
     * 勾稽数量（作废）
     */
    private BigDecimal fJoinedQty;

    /**
     * 未勾稽数量（作废）
     */
    private BigDecimal fUnjoinQty;
     ...
     * 到货确认人
     */
    private String arrivalConfirmor;
    ...
    @TableField(fill = FieldFill.INSERT)
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime fValidateDate;

    /**
     * 检验确认
     */
    private Boolean fValidateStatus;
