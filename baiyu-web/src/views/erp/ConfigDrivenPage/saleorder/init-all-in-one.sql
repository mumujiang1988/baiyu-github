...
INSERT INTO erp_page_config (
  ...
  '{
    ...
    "searchConfig":  {
                         ...
                         "fields":  [
                                        ...
                                        },
                                        {
                                            ...
                                            "dataApi":  "/erp/engine/dictionary/salespersons?moduleCode={moduleCode}",
                                            "labelField":  "nickName",
                                            "valueField":  "fseller",
                                            "defaultValue":  ""
                                        },
    ...
    "dictionaryConfig":  {
                             ...
                             "paymentTerms":  {
                                                  "api":  "/erp/engine/dictionary/listByType/payment_clause?type=payment_clause\\\\u0026moduleCode={moduleCode}",
                                                  "labelField":  "label",
                                                  "valueField":  "value"
                                              },
                             "nation":  {
                                            "api":  "/erp/engine/dictionary/listByType/nation?type=nation\\\\u0026moduleCode={moduleCode}",
                                            "labelField":  "label",
                                            "valueField":  "value"
                                        },
                             "tradeType":  {
                                               "api":  "/erp/engine/dictionary/listByType/trade_way?type=trade_way\\\\u0026moduleCode={moduleCode}",
                                               "labelField":  "label",
                                               "valueField":  "value"
                                           },
                             "orderStatus":  [
