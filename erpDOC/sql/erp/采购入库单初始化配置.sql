...
INSERT INTO `erp_page_config` (
  ...
  '{
    ...
    "columns": [
      ...
      {"prop": "f_supplier_id", "label": "供应商", "width": 120, "align": "left", "visible": true, "renderType": "text", "dictionary": "suppliers"},
            ...
            "defaultConditions": [
              {
                ...
                "operator": "eq",
                "value": "${f_bill_no}",
                "description": "按单据编号查询明细 (purchase_instock.f_bill_no = purchase_instock_entry.fbillno)"
              }
            ],
