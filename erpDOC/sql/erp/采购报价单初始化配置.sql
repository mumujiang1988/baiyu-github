...
INSERT INTO `erp_page_config` (
  ...
  '{
    ...
    "title": "{entityName}管理",
    "permission": "erp:purchasequotation:query",
    "layout": "standard",
  ...
  '{
    "toolbar": [
      {"key": "add", "label": "新增", "icon": "Plus", "permission": "erp:purchasequotation:add", "type": "primary", "position": "left", "handler": "handleAdd"},
      {"key": "edit", "label": "修改", "icon": "Edit", "permission": "erp:purchasequotation:edit", "type": "success", "position": "left", "disabled": "single", "handler": "handleUpdate"},
      {"key": "delete", "label": "删除", "icon": "Delete", "permission": "erp:purchasequotation:remove", "type": "danger", "position": "left", "disabled": "multiple", "handler": "handleDelete", "confirm": "是否确认删除选中的 {count} 条数据？"},
      {"key": "audit", "label": "审核", "icon": "CircleCheck", "permission": "erp:purchasequotation:audit", "type": "success", "position": "left", "disabled": "multiple", "handler": "handleAudit", "confirm": "是否确认审核选中的 {count} 条数据？"},
      {"key": "unAudit", "label": "反审核", "icon": "Close", "permission": "erp:purchasequotation:unAudit", "type": "warning", "position": "left", "disabled": "multiple", "handler": "handleUnAudit", "confirm": "是否确认反审核选中的 {count} 条数据？"},
      {"key": "export", "label": "导出", "icon": "Download", "permission": "erp:purchasequotation:export", "type": "warning", "position": "left", "disabled": "multiple", "handler": "handleExport"},
            ...
            "defaultConditions": [
              {
                ...
                "operator": "eq",
                "value": "${fbillno}",
                "description": "按单据编号查询明细 (purchase_quotation.fbillno = purchase_quotation_entry.fbillno)"
              }
            ],
